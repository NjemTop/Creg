...
class DatabaseCleanerMsSQL:
    def __init__(self, service_url):
        ...
        db_info = get_mssql_info(self.service_url, self.admin_username, self.admin_password)
        if db_info:
            ...
            logger.error(f'Не удалось получить информацию о базе данных')
            raise ValueError("Не удалось получить информацию о базе данных")
